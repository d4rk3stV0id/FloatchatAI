      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-b border-border/50">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <Waves className="h-6 w-6 text-[#20B2AA] dark:text-[#20B2AA]" />
            <span className="text-xl font-bold text-[#003366] dark:text-[#20B2AA]">FloatChat</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            <ThemeToggle />
            <Button onClick={() => navigate('/auth')} variant="coral" className="hidden sm:flex">
              Launch App
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="lg:w-1/2 lg:text-left space-y-8">
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-7xl font-bold tracking-tighter bg-gradient-to-r from-[#003366] via-[#4682B4] to-[#20B2AA] bg-clip-text text-transparent">
                  FloatChat
                </h1>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 text-center hover:shadow-glow transition-all duration-300 border-ocean-primary/20 card-shadow">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-[#003366] to-[#4682B4] rounded-full mb-6">
                <Database className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-xl font-semibold mb-4 text-foreground">Real-time ARGO Data</h3>
            ...
            <Card className="p-8 text-center hover:shadow-glow transition-all duration-300 border-ocean-primary/20 card-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4 text-foreground">AI Visualizations</h3>
              <p className="text-muted-foreground">
            ...
            <Card className="p-8 text-center hover:shadow-glow transition-all duration-300 border-ocean-primary/20 card-shadow">
              ...
              <h3 className="text-xl font-semibold mb-4 text-foreground">Interactive Mapping</h3>
              <p className="text-muted-foreground">
            ...
            <div className="relative">
              <Card className="p-8 card-shadow border-ocean-primary/20">
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <div className="text-3xl font-bold text-[#20B2AA] dark:text-[#20B2AA]">4000+</div>
                    <div className="text-sm text-muted-foreground">Active Floats</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-[#20B2AA] dark:text-[#20B2AA]">2000m</div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="p-6 text-center card-shadow border-ocean-primary/20">
              <Mail className="h-8 w-8 text-[#20B2AA] dark:text-[#20B2AA] mx-auto mb-4" />
              <h3 className="font-semibold mb-2 text-foreground">Email</h3>
              <a href="mailto:contact@floatchat.com" className="text-muted-foreground hover:text-[#20B2AA] dark:hover:text-[#20B2AA]">contact@floatchat.com</a>
            </Card>

            <Card className="p-6 text-center card-shadow border-ocean-primary/20">
              <Phone className="h-8 w-8 text-[#20B2AA] dark:text-[#20B2AA] mx-auto mb-4" />
              <h3 className="font-semibold mb-2 text-foreground">Phone</h3>
              <p className="text-muted-foreground">+91 80 1234 5678</p>
            </Card>

            <Card className="p-6 text-center card-shadow border-ocean-primary/20">
              <GlobeIcon className="h-8 w-8 text-[#20B2AA] dark:text-[#20B2AA] mx-auto mb-4" />
      ...
      <footer className="py-12 px-6 border-t border-border/50 bg-card/20">
        <div className="container mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            <Waves className="h-6 w-6 text-[#20B2AA]" />
            <span className="text-xl font-bold text-[#003366] dark:text-[#20B2AA]">FloatChat</span>
          </div>
          <p className="text-muted-foreground">
